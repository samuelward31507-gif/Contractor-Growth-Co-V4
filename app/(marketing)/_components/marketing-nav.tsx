...
const NAV_LINKS = [
  ...
  { href: "/#who-its-for", label: "For Contractors" },
];
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          >
            ...
            <nav aria-label="Mobile" className="mt-8 flex flex-col gap-1">
              {NAV_LINKS.map((link) => (
                <Link
                  ...
                  href={link.href}
                  onClick={() => setOpen(false)}
                  className="rounded-lg px-3 py-3 text-base font-medium text-slate-700 transition-colors hover:bg-slate-50"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="mt-auto pt-8">
              <CtaLink href="/get-started" className="w-full" onClick={() => setOpen(false)}>
                Get Your Growth System
              </CtaLink>
            </div>
          </div>
