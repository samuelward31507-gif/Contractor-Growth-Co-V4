  ...
  return (
    <div className="flex flex-1 flex-col">
      {/*
        ...
        confirm, so they lead in the hero's meta row instead of being the
      ...
      */}
      <DetailHero
        ...
        badges={
          <Badge surface="dark" tone={APPOINTMENT_STATUS_TONE[appointment.status]} icon={APPOINTMENT_STATUS_ICON[appointment.status]}>
        ...
        meta={
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-3">
            <div>
              ...
              <p className="mt-1 text-lg font-semibold text-white">{formatAppointmentDate(appointment.start_at, timeZone)}</p>
            </div>
            <div>
              <p className="flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wider text-slate-500">
            ...
            <div>
              ...
              <p className="mt-1 text-lg font-semibold text-white">{formatAppointmentDuration(appointment.start_at, appointment.end_at)}</p>
            </div>
          </div>
        }
      />
