  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm rounded-xl border border-slate-200 bg-white p-6 shadow-xl">
        <h2 className="text-lg font-semibold tracking-tight text-slate-900">Delete &quot;{service.name}&quot;?</h2>
        <p className="mt-2 text-sm text-slate-500">This will permanently remove this service.</p>
