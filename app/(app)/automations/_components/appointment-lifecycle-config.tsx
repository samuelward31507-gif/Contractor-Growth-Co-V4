...
import { updateAppointmentLifecycleConfig } from "../actions";
 ...
 */
export function AppointmentLifecycleConfigForm({
  ...
  function commit(value: boolean) {
    ...
    startTransition(async () => {
      const result = await updateAppointmentLifecycleConfig(value);
      if (result.error) {
