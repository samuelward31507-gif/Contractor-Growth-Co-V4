...
import { ArrowLeft, CalendarClock, FileSearch, MessagesSquare, Sparkles } from "lucide-react";
...
export default async function LeadDetailPage({ params }: PageProps<"/leads/[id]">) {
  ...
  return (
    <div className="flex flex-1 flex-col gap-8 px-4 py-6 sm:px-6 sm:py-8 lg:px-10 lg:py-10">
      ...
      {/* IDENTITY: who/what is this, where is it right now, what can I do */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="mt-1.5 flex items-center gap-2">
              ...
              <Badge tone={LEAD_TEMPERATURE_TONE[lead.temperature]}>{TEMPERATURE_LABELS[lead.temperature]}</Badge>
            </div>
          </div>
        </div>
      ...
      {/* VALUE: what matters financially, given the strongest number treatment on the page */}
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8">
        {/* MAIN COLUMN: activity, qualification, appointments, estimates */}
